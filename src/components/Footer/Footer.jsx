    ...
    <footer>
      <div className="bg-[#f7f8f9]" id="sub-footer">
        <div className="px-8 grid grid-cols-12 gap-8 items-center">
          ...
          <div className="col-span-4  flex flex-col justify-center h-[80%] border-r-2 border-gray-400">
            <h1 className="text-4xl font-bold py-6">TRY THE OLX APP</h1>
            <p className="text-xl font-regular pb-10 ">
      ...
      <div id="main-footer" className="bg-[#ebeeef]">
        <div className="px-8 grid grid-cols-11 gap-12 pt-4 pb-12">
          <div className="col-span-2">
            ...
            <ul className="text-xs mt-2 text-gray-500 ">
              ...
              <li className="cursor-pointer hover:text-gray-900 pb-1">
                Flats for rent
              </li>
              <li className="cursor-pointer hover:text-gray-900 pb-1">
                Mobile phones
          ...
          <div className="col-span-3">
            ...
            <div id="links" className="grid grid-cols-3 mt-6 gap-2">
              <Link
                to="https://apps.apple.com/pk/app/olx-pakistan-online-shopping/"
                className="col-span-1"
                target="_blank"
      ...
      <div
        id="mini-footer"
        className="bg-[#002F34] px-8 py-4 flex items-end justify-end text-gray-100"
      >
